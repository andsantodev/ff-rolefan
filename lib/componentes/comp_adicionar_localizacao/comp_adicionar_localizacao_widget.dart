...
import 'comp_adicionar_localizacao_model.dart';
export 'comp_adicionar_localizacao_model.dart';

class CompAdicionarLocalizacaoWidget extends StatefulWidget {
  const CompAdicionarLocalizacaoWidget({super.key});

  @override
  State<CompAdicionarLocalizacaoWidget> createState() =>
      _CompAdicionarLocalizacaoWidgetState();
}

class _CompAdicionarLocalizacaoWidgetState
    extends State<CompAdicionarLocalizacaoWidget> {
  late CompAdicionarLocalizacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompAdicionarLocalizacaoModel());
